...
potted plant, houseplant, pot plant, plants, plant
bed
...
# synonyms_txt = binary_chair.synonyms_txt
...
class CHAIR(object):
    ...
    def __init__(self, coco_path):
        ...
        #### 여기에, 아직 없는 double words들 감지되면 등록하기
        #### self.double_word_dict['아직없는거'] = 표현할 대표어 
        #### 형태로
        self.double_word_dict['bow tie'] = 'tie'
        self.double_word_dict['toilet seat'] = 'toilet'
        self.double_word_dict['wine glas'] = 'wine glass'
        self.double_word_dict['pot plant'] = 'potted plant'
        self.double_word_dict['pot plants'] = 'potted plant'
        self.double_word_dict['ski pole'] = 'pole'
    ...
    def caption_to_words(self, caption):
        ...
        #    print(f'nlp된후 공백으로 합친 문자열 : {double_word}')
    ...
    def process_sentence_get_coco_objects(self, caption):
        ...
        for word in words:
            node_words.append(self.inverse_synonym_dict[word])
        #return all the MSCOCO objects in the caption
        return list(set(node_words))
    

    def process_sentence_get_coco_synonyms(self, caption):
        ...
        node_words = []
        for word in words:
            node_words.append((self.inverse_synonym_dict[word],word))
        
        result = []
        for changed_word, word in node_words:
            result.append((changed_word,word))
...
# python chair.py \
# --cap_file /home/work/jihoon_wombat_storage/eyetrack/llava-1.5-7b-hf_greedy_captions_256tokens.jsonl \
# --image_id_key image_id --caption_key caption \
# --coco_path /home/work/jihoon_wombat_storage/COCO_DIR/annotations/ \
# --save_path /home/work/jihoon_wombat_storage/eyetrack/llava-1.5-7b-hf_greedy_captions_256tokens.json \
