...
# Test script for LLaVA-1.5 model
# Configuration: eval_configs/llava-1.5_eval.yaml

# Default parameters (modify as needed)
MODEL="llava-1.5"
MODEL_PATH="${MODEL_PATH:-/datasets2/llava-1.5-7b-hf}"
...
echo "Running LLaVA-1.5 POPE evaluation..."
echo "Model: $MODEL"
